...
{
    /// <summary>
    /// Klasa LFigure dziedzicząca po clasie abstrakcyjnej Figure i interfejsach ICreate i IRorate
    ...
    /// </summary>
    class LFigure : Figure, ICreate, IRotate
    {
        /// <summary>
        ...
        public void Create()
        {
            color = Color.Yellow; // Ustawienie koloru na żółty dla figury L
            grid[0, 0] = grid[0, 1] = grid[0, 2] = grid[1, 2] = true; // Zmiana odpowiednich pól w siatce tak, aby utworzyć figurę L
        }
        ...
        public void Rotate()
        {
            ...
            {
                case 0:
                    grid[0, 0] = grid[0, 1] = grid[0, 2] = grid[1, 2] = true;
                    break;
                case 90:
                    grid[0, 0] = grid[1, 0] = grid[2, 0] = grid[0, 1] = true;
                    break;
                case 180:
                    grid[0, 0] = grid[1, 0] = grid[1, 1] = grid[1, 2] = true;
                    break;
                case 270:
                    grid[2, 0] = grid[0, 1] = grid[1, 1] = grid[2, 1] = true;
                    break;
                default:
                    break;
            }
